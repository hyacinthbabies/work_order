...
var loadQuill = async () => {
  ...
  quillLoadPromise !== null && quillLoadPromise !== void 0 ? quillLoadPromise : quillLoadPromise = import("./quill-VMPVT5YC.js").then(({ default: Quill2 }) => {
    loadedQuill = Quill2;
